...
<p align="center">
  <img src="https://raw.githubusercontent.com/fanzxnothuman/client/refs/heads/main/thumbnail.png" alt="Thumbnail" />
</p>
...
await sock.sendMessage(jid, { 
  eventMessage: { 
    ...
    joinLink: "https://call.whatsapp.com/video/fanzxnothuman", 
...
await sock.sendMessage(jid, {
  interactiveMessage: {
    header: "Hello World",
    title: "shut your bitch ass up",
    footer: "telegram: @fanzxnothuman",
    document: fs.readFileSync("./package.json"),
    mimetype: "application/pdf",
    fileName: "─!s fánn sx.pdf",
...
- Has 1 newsletter follow, only the developer's WhatsApp channel: [WhatsApp Channel](https://whatsapp.com/channel/0029VbA69WNDDmFMgxLdoA0U)
...
- **Telegram**: [Telegram Contact](https://t.me/fanzxnothuman)
- **Channel WhatsApp**: [Channel WhatsApp](https://whatsapp.com/channel/0029VbA69WNDDmFMgxLdoA0U)
  ...
  <tr>
    ...
    <td align="center">
      <a href="https://github.com/fanzxnothuman">
        <img src="https://github.com/fanzxnothuman.png" width="80px;" style="border-radius:50%;" alt="Contributor"/>
        <br />
        <sub><b>FannX7</b></sub>
      </a>
    </td>
